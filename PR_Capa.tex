...
\begin{titlepage}
    ...
    \small
        ...
        %
        \item As respostas das questões objetivas devem ser marcadas no gabarito com \textbf{caneta azul ou preta}. Questões marcadas a lápis ou com rasura receberão nota zero.
        %
