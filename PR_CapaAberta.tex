...
\begin{titlepage}
    ...
    \small
        ...
        %
        \item Escreva as respostas das questões objetivas no espaço indicado, utilizando \textbf{caneta azul ou preta}. Respostas escritas a lápis, ilegíveis ou com rasuras que impeçam sua correta identificação receberão nota zero.
        %
        \item Não é necessário justificativa nas questões objetivas; apenas a resposta correta será considerada.
        %
