...
\begin{document}
    ...
    \input{../FuncoesExponenciais/FE_Exercicio6}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 2}
    \input{../FuncoesExponenciais/FE_Exercicio17}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 3}
    \input{../FuncoesExponenciais/FE_Exercicio20}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 4}
    \input{../FuncoesLogaritmicas/FL_Exercicio8}
    \pagebreak
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 5}
    \input{../FuncoesLogaritmicas/FL_Exercicio14}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 6}
    \input{../FuncoesLogaritmicas/FL_Exercicio18}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 7}
    \input{../TrigonometriaI/TI_Exercicio27}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 8}
    \input{../TrigonometriaI/TI_Exercicio28}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 9}
    \input{../TrigonometriaI/TI_Exercicio29}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 10}
    \input{../TrigonometriaII/TII_Exercicio6}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 11}
    \input{../TrigonometriaII/TII_Exercicio13}
    \vspace{15pt}
    
    \phantomsection
    \addcontentsline{toc}{section}{Exercício 12}
    \input{../TrigonometriaII/TII_Exercicio14}
    \vspace{15pt}
